<?php include "application/views/includes/template_header.php"; ?>
    <main class="inside-content">
        ...
        <section class="feedback-form">
            <?php if (empty($Session['flag'])): ?>
                <p style="font-size:16px">Благодарим за ваше письмо. Мы свяжемся с вами в ближайшее время!</p>
            <?php else: ?>
            ...
            <form method="POST" class="registration-form" action="contacts.php" name="contats-page__feedback-form">

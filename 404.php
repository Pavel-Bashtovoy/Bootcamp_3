...
<head>
    ...
    <link rel="stylesheet" href="application/views/includes/css/stylesheet.css">
    <link rel="shortcut icon" href="img/favicon.png" type="image/png">
    <link rel="alternate" href="https://allfont.ru/allfont.css?fonts=arial-narrow">
    <script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
    <script src="application/views/includes/js/script.js"></script>
        ...
        <div class="wrapper">
            ...
            <ul class="menu-togglable">
                <li class="header-nav-item"><span><a class="header-nav-item__link"
                                                     href="index.php">Вернуться на главную</a></span></li>
            </ul>
        </div>
    </nav>
</header>
